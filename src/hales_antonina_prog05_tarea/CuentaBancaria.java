...
package hales_antonina_prog05_tarea;
...
public class CuentaBancaria {
    ...
    /**
     * Constructor que recibe todos los parámetros requeridos
     * 
     * 
     * @param titular Nombre del titular de la cuenta (entre 10 y 50 caracteres)
     * @param entidad Número de la entidad (4 dígitos numéricos)
     * @param oficina Número del código de la oficina (4 dígitos numéricos
     * @param DC Los dos dígitos de control
     * @param numCuenta Número de la cuenta (10 dígitos numéricos)
    ...
    public CuentaBancaria(String titular, String entidad, String oficina, String DC,String numCuenta) throws Exception{
        ...
        if(titular.length()<MINLENGTH || titular.length()>MAXLENGTH) 
            throw new IllegalArgumentException("Sólo se admiten nombres de titular entre 10 y 50 caracteres");
			
        /* Comparamos lo introducido como entidad con el valor numérico que tiene
           para que en caso de no ser iguales, lance la excepción (no se han introducido
           valores numéricos para la entidad) 
           Hacemos lo mismo con la oficina y el número de la cuenta*/
        ...
        if(!numCuenta.equals(String.valueOf(Long.parseLong(numCuenta))))
   ...
   /**
     * Comprobamos CCC, ya que los dígitos
     * de control lo calculamos en el método obtenerDigitosControl
     * 
     * @param CCC
     * @<code>CCC</code> Cadena de 18 dígitos para los que comprobaremos su validez
